	...
	<body>
		...
		<div id="show-category" class="content scaffold-show" role="main">
			...
			<ol class="property-list category">
				...
				<g:if test="${categoryInstance?.grade}">
				<li class="fieldcontain">
					<span id="grade-label" class="property-label"><g:message code="category.grade.label" default="Grade" /></span>
					
						<span class="property-value" aria-labelledby="grade-label"><g:fieldValue bean="${categoryInstance}" field="grade"/></span>
