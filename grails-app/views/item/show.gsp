			...
			<ol class="property-list item">
				...
				<li class="fieldcontain">
					<span id="type-label" class="property-label"><g:message code="item.type.label" default="Type" /></span>
						...
						<span class="property-value" aria-labelledby="type-label"><g:fieldValue bean="${itemInstance}" field="type"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${itemInstance?.content}">
				<li class="fieldcontain">
					<span id="content-label" class="property-label"><g:message code="item.content.label" default="Content" /></span>
					
						<span class="property-value" aria-labelledby="content-label"><g:fieldValue bean="${itemInstance}" field="content"/></span>
