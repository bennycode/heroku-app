		...
		<div id="list-item" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="content" title="${message(code: 'item.content.label', default: 'Content')}" />
				...
				<g:each in="${itemInstanceList}" status="i" var="itemInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${itemInstance.id}">${fieldValue(bean: itemInstance, field: "type")}</g:link></td>
					
						<td>${fieldValue(bean: itemInstance, field: "content")}</td>
