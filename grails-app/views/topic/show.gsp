	...
	<body>
		...
		<div id="show-topic" class="content scaffold-show" role="main">
			...
			<ol class="property-list topic">
				...
				<g:if test="${topicInstance?.contents}">
				<li class="fieldcontain">
					<span id="contents-label" class="property-label"><g:message code="topic.contents.label" default="Contents" /></span>
					
						<span class="property-value" aria-labelledby="contents-label"><g:fieldValue bean="${topicInstance}" field="contents"/></span>
